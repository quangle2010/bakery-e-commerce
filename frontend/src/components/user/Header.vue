        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-none d-lg-flex">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 py-2" aria-labelledby="accountDropdown">
                <template v-if="!auth.isAuthenticated">
                  <li>
                    <router-link class="dropdown-item py-2 px-3 rounded-3 mb-1 mx-1 transition-all" to="/login">
                      <i class="bi bi-box-arrow-in-right me-2 text-primary"></i> Đăng nhập
                    </router-link>
                  </li>
                  <li>
                    <router-link class="dropdown-item py-2 px-3 rounded-3 mb-1 mx-1 transition-all" to="/register">
                      <i class="bi bi-person-plus me-2 text-primary"></i> Đăng ký
                    </router-link>
                  </li>
                </template>
                <template v-else>
                  <li>
                    <router-link class="dropdown-item py-2 px-3 rounded-3 mb-1 mx-1 transition-all" to="/user/profile">
                      <i class="bi bi-person-vcard me-2 text-primary"></i> Thông tin tài khoản
                    </router-link>
                  </li>
                  <li>
                    <router-link class="dropdown-item py-2 px-3 rounded-3 mb-1 mx-1 transition-all" to="/user/orders">
